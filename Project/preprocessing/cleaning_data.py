...
class Preprocessing:
    ...
    def process(self, user_inputs):
        ...
        input_df = pd.DataFrame([user_inputs], columns=['Locality', 'Zip code', 'Property type', 'Bedrooms', 'Living area', 
                                                        'Surface of the plot', 'Facades', 'Building condition', 'Fireplace', 
                                                        'Equipped kitchen', 'Garden', 'Garden surface', 'Terrace', 
                                                        'Terrace surface', 'Furnished', 'Swimming pool', 'Region'])
